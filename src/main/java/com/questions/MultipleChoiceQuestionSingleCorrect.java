	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(userId == 0 || access) {
				...
				Integer answer = 0;
				System.out.println(sectionIdString + " end");
				System.out.println(questionString + " end");
				System.out.println(answerString + " end");
				System.out.println(scoreString + " end");
				System.out.println(negativeMarkingString + " end");
				System.out.println(explanationString + " end");
				System.out.println(timeDurationString + " end");
				System.out.println(categoryIdString + " end");
				System.out.println(mcqOptionAnswerString + " end");
				
				
				for(String option : answerString) {
